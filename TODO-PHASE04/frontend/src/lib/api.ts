...
// const API_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000";
   ...
   export const API_BASE_URL = "https://sobiarao-phase-3-chatbot.hf.space";// ya localhost:8000;
...
export async function apiRequest<T>(
  ...
  // Get token from localStorage (saved on login/signup)
...
// /**
//  * Make an authenticated API request.
//  * Automatically includes JWT Bearer token and handles errors.
//  */
// export async function apiRequest<T>(
//   endpoint: string,
//   options: RequestInit = {}
...
//       response.status,
//       errorData.error || errorData.detail?.error
//     );
//   }
